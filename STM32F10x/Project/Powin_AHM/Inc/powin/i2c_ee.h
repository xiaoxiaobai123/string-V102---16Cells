...
void MemCopy(uint8_t *Dest,uint8_t *Src,uint32_t Num);

void CopyAHKWHToEEPROMTemp(void);
void CopyOverVolThresholdValueToEEPROM(void);
void CopyUnderVolThresholdValueToEEPROM(void);
void CopyOverTempThresholdValueToEEPROM(void);
void CopyUnderTempThresholdValueToEEPROM(void);
